...
SWEP.Gun 					= ("is_usp") -- must be the name of your swep but NO CAPITALS!
SWEP.Category				= "Isolation"
SWEP.Author					= "Wayward"
SWEP.Contact				= "http://docs.isolation.cf"
SWEP.Purpose				= ""
SWEP.Instructions			= ""
...
SWEP.ViewModel				= "models/weapons/m14/m14.mdl"	-- Weapon view model
SWEP.WorldModel				= "models/weapons/m14/m14.mdl"	-- Weapon world model
SWEP.Base					= "is_weapon_base"
SWEP.Spawnable				= true
